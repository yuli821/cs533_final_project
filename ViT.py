...
class myMlp(nn.Module) :
    ...
    '''
    def __init__(self, in_features=16, hidden_features=64, out_features=16, act_layer=nn.ReLU):
        super().__init__()
...
class vit(nn.Module) :
    ...
    def __init__(self, ipch=1, Nclasses=10, image_size=32, d_model=32,
        ...
        self.classembed = nn.Parameter(torch.randn(1, 1, d_model))                    #label embedding
        self.posencode = nn.Parameter(torch.randn(1, num_patches+1, d_model))         #positional encoding
